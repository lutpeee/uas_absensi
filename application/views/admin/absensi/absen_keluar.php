        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <label style="font-size:40px;font-family:calibri">Absen Keluar Karyawan </label>


                        <form action="<?php echo base_url('karyawan/absensi/keluar'); ?>" method="post">




                            <input class="form-control" type="number" name="NIK" placeholder="Nomer Induk Karyawan"><br><br>
                            <input type="hidden" name="kode_absen" value="Keluar">
